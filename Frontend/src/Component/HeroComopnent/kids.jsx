...
let kids = all_product.filter(e => e.category === "kid")
export default function Kids() {
  return (
    <div className='bg-gray-100 h-dvh overflow-y-scroll   pb-14 max-[450px]:w-screen max-[450px]:overflow-x-hidden max-[450px]:pb-[5rem] '>
      <img className='cursor-pointer' src="/Assets/banner_kids.png" alt="" />
      <h3 className='text-center text-3xl font-semibold text-red-600 py-5'>Kids Category</h3>
      <hr className='border-gray-500 mx-auto w-[30rem]' />
      <div className='grid grid-cols-4 gap-10 p-5 max-[450px]:block max-[450px]:p-1 '>
        {kids && kids.map((item) =>
          <div className='border p-2 rounded-md
          max-[450px]:block max-[450px]:-ml-1 max-[450px]:w-screen max-[450px]:mb-5 max-[450px]:p-1' key={item.id}>
