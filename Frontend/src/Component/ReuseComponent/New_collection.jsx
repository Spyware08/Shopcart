                ...
                {new_collections && new_collections.map((item) =>
                    <div key={item.id}>
                        <div className='bg-gray-200 p-3 m-2 max-[450px]:m-4 rounded-md' >
                            ...
                            <h2 className='font-semibold max-[450px]:text-sm max-[450px]:ml-[2.4rem]'> {item.name}</h2>
                            <p className=' max-[450px]:text-sm max-[450px]:ml-[2.4rem]'> Category: <span className=' font-semibold'>{item.category}</span></p>
                            <p className='max-[450px]:text-sm max-[450px]:ml-[2.4rem]'> <span className='text-green-800 font-bold'>Price</span>: ${item.new_price}
