            ...
            <form action='/signup' method='post' className='w-[40rem] m-1 border p-5 mx-auto rounded-lg max-[450px]:w-screen' onSubmit={handleSubmit}>
                <div className="space-y-12">
                    <div className="border-b border-gray-900/10 pb-12">
                        <h2 className="text-base font-semibold leading-7 text-gray-900 flex">Signup here with <span className='flex items-center mx-2 text-green-800 font-semibold'><FaShopify />ShopCart</span></h2>
