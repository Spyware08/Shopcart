        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form className="space-y-6"  >
            ...
            <div>
              ...
              <button  onClick={()=>{navigate("/")}} className="flex w-full justify-center rounded-md text-black bg-white-600 px-3 py-1.5 text-sm font-semibold leading-6shadow-sm hover:border hover:bg-blue-200">Cancel</button>
            </div>
          </form>
        </div>
      </div>
